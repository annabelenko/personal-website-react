    ...
    <div className="projects-container" id="work">
      ...
      <div className="projects-grid">
        ...
        <div className="project-card">
          <img src={project1} alt="StormShoppr" className="project-image" />
        ...
        {/* Project 2 */}
        <div className="project-card">
          <img src={project2} alt="Elevators & Economic Injustice" className="project-image" />
          <div className="project-content">
            <div className="project-right">
        ...
        {/* Project 3 */}
        <div className="project-card">
          <img src={project4} alt="Note-Taking Platform" className="project-image" />
          <div className="project-content">
            <div className="project-right">
        ...
        {/* Project 4 */}
        <div className="project-card">
          <img src={project3} alt="Ramadan Website" className="project-image" />
          <div className="project-content">
            <div className="project-right">
